...
namespace Game._Script.GunComponent
{
    public class LookAt : MonoBehaviour
    {
        ...
        [SerializeField]
        private float RotationRadius = 1f; // Расстояние от родителя
        ...
        private void LookProcess()
        {
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation, targetRotation, RotationSpeed * Time.deltaTime * 5f);

            transform.position = parentPos + direction * RotationRadius;
        }
        ...
        private void OnDrawGizmos()
        {
            ...
            DrawCircle(ParentTransform.position, RotationRadius, 16);
